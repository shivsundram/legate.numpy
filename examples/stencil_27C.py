...
def run(grid, I, N):  # noqa: E741
    ...
    for i in range(I):
        g00 = .037*g000 + .037*g001 + .037*g002
        g01 = .037*g010 + .037*g011 + .037*g012
        g02 = .037*g020 + .037*g021 + .037*g022
        g10 = .037*g100 + .037*g101 + .037*g102
        g11 = .037*g110 + .037*g111 + .037*g112
        g12 = .037*g120 + .037*g121 + .037*g122
        g20 = .037*g200 + .037*g201 + .037*g202
        g21 = .037*g210 + .037*g211 + .037*g212
        g22 = .037*g220 + .037*g221 + .037*g222
